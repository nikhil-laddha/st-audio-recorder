...
class AudioRecorder extends StreamlitComponentBase<AudioRecorderState> {
  public constructor(props: AudioRecorderProps) {
    super(props)
    this.state = { color: this.props.args["neutral_color"], recordState: RecordState.STOP }
  }
    ...
    return (
      <div>
        ...
        {/* <AudioReactRecorder
          ...
          onStop={(audioData) => {console.log("STOPPED")}}
          type='audio/wav'
        ...
        <AudioReactRecorder state={this.state.recordState}
          backgroundColor='rgb(255, 255, 255)'
          foregroundColor='rgb(255,76,75)'
          canvasWidth={300}
          canvasHeight={100} onStop={this.onStop} />
      </div>
